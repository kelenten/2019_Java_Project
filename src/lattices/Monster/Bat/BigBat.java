...
public class BigBat extends Monster {
    ...
    private int gold = 8;
    private double poison = 0.98;
    private int additionalAt = 10;
    ...
    public void getAnimation(StackPane stackPane){
        Image i1 = new Image("file:pic/Monsters/大蝙蝠1.png");//形态一
        Image i2 = new Image("file:pic/Monsters/大蝙蝠2.png");//形态二
    ...
    public String virtualAttack(Player player){
        ...
        loop:while (true){
            ...
            if(vBlood > 0) {
                ...
                player.setGold(player.getGold() + this.gold);
                return "可以击败大蝙蝠，共受到" + total + "点伤害，其中中毒和额外伤害共" + exD;
            }
            if(player.getBlood() <= 0){
                return "你打不过，将受到" + total + "点伤害，其中中毒和额外伤害共" + exD;
            }
    ...
    public ImageView getPic(){
        ImageView imageView;
        if(exist){
            imageView = new ImageView(new Image("file:pic/Monsters/大蝙蝠1.png"));
            return imageView;
        } else{
