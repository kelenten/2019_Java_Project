...
public class SkeletonMan extends Monster {
    private int blood = 120;
    private int attack = 70;
    private int defence = 0;
    private int gold = 5;
    private int specialAttackRate = 20;
    ...
    public void getAnimation(StackPane stackPane){
        Image i1 = new Image("file:pic/Monsters/骷髅人1.png");//形态一
        Image i2 = new Image("file:pic/Monsters/骷髅人2.png");//形态二
        ...
        loop:while (exist){
            ...
            if(this.blood > 0) {
                ...
                if(player.getBlood() <= 0) {
                    System.out.println("你被骷髅人击杀，游戏失败！");
                    System.exit(0);
                }
            } else {
                System.out.println("击败骷髅人!");
    ...
    public String virtualAttack(Player player){
        ...
        while (true){
            ...
            if(vBlood> 0) {
                ...
                if(player.getBlood() <= 0) {
                    return "你可能被骷髅人击杀！共受到伤害"+total+"，其中特殊攻击"+sAF+"次";
                }
            } else {
                player.setGold(player.getGold() + gold);
                return "你可能击败骷髅人，共受到伤害" +total + "，其中特殊攻击"+sAF+"次";
            }
        }
    }
    ...
    public ImageView getPic(){
        ImageView imageView;
        if(exist){
            imageView = new ImageView(new Image("file:pic/Monsters/骷髅人1.png"));
            return imageView;
        } else{
